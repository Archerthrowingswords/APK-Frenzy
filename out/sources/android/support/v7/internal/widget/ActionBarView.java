...
public class ActionBarView extends AbsActionBarView {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (homeLayout.getVisibility() != 8) {
            ...
            if (lp.width < 0) {
                homeWidthSpec = View.MeasureSpec.makeMeasureSpec(availableWidth, ExploreByTouchHelper.INVALID_ID);
            } else {
            ...
            switch (this.mNavigationMode) {
                case 1:
                    if (this.mListNavLayout != null) {
                        ...
                        this.mListNavLayout.measure(View.MeasureSpec.makeMeasureSpec(availableWidth2, ExploreByTouchHelper.INVALID_ID), View.MeasureSpec.makeMeasureSpec(height, 1073741824));
                ...
                case 2:
                    if (this.mTabScrollView != null) {
                        ...
                        this.mTabScrollView.measure(View.MeasureSpec.makeMeasureSpec(availableWidth3, ExploreByTouchHelper.INVALID_ID), View.MeasureSpec.makeMeasureSpec(height, 1073741824));
        ...
        if (customView != null) {
            ...
            if (this.mContentHeight <= 0) {
                ...
                customNavHeightMode = lp2.height != -2 ? 1073741824 : ExploreByTouchHelper.INVALID_ID;
            }
            if (lp2.height >= 0) {
                height = Math.min(lp2.height, height);
            }
            int customNavHeight = Math.max(0, height - verticalMargin);
            int customNavWidthMode = lp2.width != -2 ? 1073741824 : ExploreByTouchHelper.INVALID_ID;
        ...
        if (this.mProgressView != null && this.mProgressView.getVisibility() != 8) {
            this.mProgressView.measure(View.MeasureSpec.makeMeasureSpec(contentWidth - (this.mProgressBarPadding * 2), 1073741824), View.MeasureSpec.makeMeasureSpec(getMeasuredHeight(), ExploreByTouchHelper.INVALID_ID));
        }
    }
